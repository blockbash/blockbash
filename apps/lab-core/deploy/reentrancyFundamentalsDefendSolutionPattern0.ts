...
/*
 ContractNames.AttackerSolutionPattern0 will try to exploit ContractNames.VulnerableSolutionPattern0
 */
// config
...
const vulnerableContractName =
  tutorialConfigConst.ContractName.VulnerableSolutionPattern0;
const challengeGroupGUID =
  tutorialConfigConst.ChallengeGroupGUID.reentrancyFundamentalsDefendSolutionPattern0;
