...
import {SVGModal, Tip, UnorderedList} from "@components"
import SVG
...
## Code {#code}
<Tip content={<chakra.span>Don't worry if the code (below) doesn't make complete sense. You'll learn about it in more detail within the process diagram (seen later in this page).</chakra.span>}></Tip>
...
<Tip content={
  <UnorderedList
    steps={[
      ...
      <chakra.span>Click on the diagram to zoom in</chakra.span>,
    ]}></UnorderedList>
}></Tip>
